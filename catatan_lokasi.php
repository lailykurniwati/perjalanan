			...
			<div class="col-auto col-x1-2 px-sm-2 px-0 navigasi">
				...
				<div class="col py-3 beranda">
					<div class="text-center">
						<marquee bgcolor="" width="500" height="40" class=""><h2>Catatan Lokasi</h2></marquee>
					</div>
					...
					<tbody>
						...
						while($d = mysqli_fetch_array($data)){
							...
							<tr>
								...
								<td><button type="submit" class="btn btn-info"><a href="edit.php">Edit</a></button></td>
								<td><button type="delete" class="btn btn-info"><a href="hapus1.php">Hapus</button></td>
							</tr>
							<?php
						}
						?>
